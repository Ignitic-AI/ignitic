...
class WorkflowTemplate(Document):
    ...
    u_id: Optional[str] = Field(default=None, description="User identifier, if custom template")
    org_id: Optional[str] = Field(default=None, description="Organization identifier, if custom template")
