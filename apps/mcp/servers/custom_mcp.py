...
app.tool(
    google_dork_search,
    meta={"ignitic_identifier": "tools.product_researcher.google_dork_search"},
)
app.tool(
    apify_amazon_search,
    meta={"ignitic_identifier": "tools.product_researcher.apify_amazon_search"},
)
app.tool(
    apify_ebay_search,
...
# Shopify tools
app.tool(
    create_product, meta={"ignitic_identifier": "tools.shopify_agent.create_product"}
)
app.tool(
    get_product_by_id,
    meta={"ignitic_identifier": "tools.shopify_agent.get_product_by_id"},
)
app.tool(get_products, meta={"ignitic_identifier": "tools.shopify_agent.get_products"})
app.tool(
    delete_product, meta={"ignitic_identifier": "tools.shopify_agent.delete_product"}
)
app.tool(
    publish_product, meta={"ignitic_identifier": "tools.shopify_agent.publish_product"}
)
app.tool(
    unpublish_product,
    meta={"ignitic_identifier": "tools.shopify_agent.unpublish_product"},
)

# HubSpot CRM tools
app.tool(
    hubspot_crm_search,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_crm_search"},
)
app.tool(
    hubspot_crm_get, meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_crm_get"}
)
app.tool(
    hubspot_crm_create,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_crm_create"},
)
app.tool(
    hubspot_crm_update,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_crm_update"},
)
app.tool(
    hubspot_crm_archive,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_crm_archive"},
)
app.tool(
    hubspot_crm_batch_read,
...
app.tool(
    hubspot_associations_create_batch,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_associations_create_batch"
    },
)
app.tool(
    hubspot_associations_read_batch,
...
app.tool(
    hubspot_associations_archive_batch,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_associations_archive_batch"
    },
)
app.tool(
    hubspot_companies_merge,
...
app.tool(
    hubspot_lists_search,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_lists_search"},
)
app.tool(
    hubspot_list_get,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_list_get"},
)
app.tool(
    hubspot_list_memberships_join_order,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_list_memberships_join_order"
    },
)
app.tool(
    hubspot_list_memberships_add_remove,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_list_memberships_add_remove"
    },
)
app.tool(
    hubspot_list_record_memberships,
...
app.tool(
    hubspot_files_search,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_files_search"},
)
app.tool(
    hubspot_file_get,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_file_get"},
)
app.tool(
    hubspot_folder_get,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_folder_get"},
)
app.tool(
    hubspot_forms_list,
    meta={"ignitic_identifier": "tools.hubspot_agent.hubspot_forms_list"},
)
app.tool(
    hubspot_communication_preferences_definitions,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_communication_preferences_definitions"
    },
)
app.tool(
    hubspot_communication_preferences_statuses_get,
    meta={
        "ignitic_identifier": "tools.hubspot_agent.hubspot_communication_preferences_statuses_get"
    },
)
app.tool(
    hubspot_crm_pipelines_list,
...
app.tool(
    create_text_file, meta={"ignitic_identifier": "tools.gdrive_agent.create_text_file"}
)
app.tool(
    update_file_content,
...
app.tool(
    list_permissions, meta={"ignitic_identifier": "tools.gdrive_agent.list_permissions"}
)
app.tool(
    remove_permission,
...
# Facebook Page tools
app.tool(
    create_post, meta={"ignitic_identifier": "tools.facebook_page_agent.create_post"}
)
app.tool(
    get_page_posts,
...
app.tool(
    delete_post, meta={"ignitic_identifier": "tools.facebook_page_agent.delete_post"}
)
app.tool(
    post_image, meta={"ignitic_identifier": "tools.facebook_page_agent.post_image"}
)
app.tool(
    get_post_comments,
