...
product_researcher_prompt = (
    (
        ...
        "'apify_ebay_search' (eBay), 'apify_alibaba_supplier_search' (Alibaba supplier companies), "
        "'apify_alibaba_product_search' (Alibaba wholesale product listings: price/MOQ/reviews/orders).\n"
        ...
        "- Use apify_alibaba_supplier_search for Alibaba.com manufacturer/supplier profiles (max_pages=1).\n"
        "- Use apify_alibaba_product_search for Alibaba.com product SERP-style data (pricing, MOQ, supplier badges, "
        "orders_count; max_pages=1).\n"
