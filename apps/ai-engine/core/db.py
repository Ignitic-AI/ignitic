...
from models.automations.n8n.n8n_credential import N8NCredential, N8NSMTPCredential
...
async def init_db():
    try:
        ...
        await init_beanie(database=client[DB_NAME], document_models=[N8NWorkflowTemplate, N8NSMTPCredential])
