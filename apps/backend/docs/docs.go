...
"/api/v1/organizations/{id}/business-profile": {
  ...
  "/api/v1/workflow-template/n8n/import": {
    "post": {
      ...
      "description": "Import an N8N workflow template as an agent tool. The ignitic_identifier determines which AI agent receives this workflow (format: workflows.n8n.<agent_name>.<tool_name>).",
      "consumes": ["application/json"],
      "produces": ["application/json"],
      "tags": ["workflow"],
      ...
      "parameters": [
        {
          "name": "body",
          "in": "body",
          "description": "Workflow import data including ignitic_identifier, name, description, inputs/outputs schema, and workflow_data",
          "required": true,
          "schema": { "$ref": "#/definitions/N8nWorkflowImport" }
        }
      ],
      "responses": {
        "200": { "description": "Workflow imported successfully", "schema": { "$ref": "#/definitions/WorkflowTemplate" } },
        "400": { "description": "Invalid request or malformed workflow data", "schema": { "type": "object", "additionalProperties": true } },
        "401": { "description": "Unauthorized", "schema": { "type": "object", "additionalProperties": true } }
      }
    }
  },
  ...
  "/api/v1/analytics/tool/executions/{execution_id}": {
    ...
    "definitions": {
        ...
        "WorkflowInputField": {
            "type": "object",
            "description": "Defines a single input parameter for a workflow tool.",
            "properties": {
                "type": {
                    "type": "string",
                    "description": "Python type string: str, int, float, bool, List[str], Dict[str, Any], etc.",
                    "example": "str"
                },
                "required": {
                    "type": "boolean",
                ...
                "default": {
                    "description": "Default value for this input (any type)."
                }
            }
        },
        "WorkflowOutputField": {
            "type": "object",
            "description": "Defines a single output field for a workflow tool.",
            "properties": {
                "type": {
                    "type": "string",
                    "description": "Python type string: str, int, float, bool, List[str], Dict[str, Any], etc.",
        ...
        "N8nWorkflowImport": {
            "type": "object",
            "description": "Request body to import an N8N workflow as an agent tool. The ignitic_identifier determines which AI agent receives this workflow.",
            "required": ["ignitic_identifier", "name", "description", "workflow_data"],
            "properties": {
                "ignitic_identifier": {
                    "type": "string",
                    "description": "Dot-separated identifier that maps the workflow to an agent. Format: workflows.n8n.<agent_name>.<tool_name>",
                    "example": "workflows.n8n.marketer.my_email_tool"
                },
                "name": {
                    "type": "string",
                    "description": "Display name of the workflow tool.",
                    "example": "My Custom Email Tool"
                },
                "description": {
                    "type": "string",
                    "description": "Description of what the workflow does.",
                    "example": "Sends a personalized email to a customer"
                },
                "inputs": {
                    "type": "object",
                    "description": "Input schema: a map of parameter name to field definition (type, required, description).",
                ...
                "outputs": {
                    "type": "object",
                    "description": "Output schema: a map of field name to field definition (type, description).",
                    "additionalProperties": {
                ...
                "workflow_data": {
                    "type": "object",
                    "description": "The raw N8N workflow JSON containing nodes, connections, and settings.",
                    "additionalProperties": true
                }
            }
        },
        "WorkflowTemplate": {
            "type": "object",
            "description": "A stored workflow template record.",
            "properties": {
                "id": {
                    "type": "string",
                    "format": "uuid",
