                ...
                <CardContent>
                  <form onSubmit={handleRequestToken} className="space-y-5">
                    ...
                    <Button
                      ...
                      className="w-full bg-primary-lm dark:bg-primary hover:opacity-90 transition"
                    >
                      {isSubmitting ? (
                        <>
            ...
            >
              <Card className="bg-bg-light-lm dark:bg-bg-light border-gray-800">
                ...
                <CardContent className="space-y-4">
                  <Link href="/signin">
                    <Button className="w-full bg-primary-lm dark:bg-primary hover:opacity-90 transition">
                      Go to Sign In
                    </Button>
                  </Link>
                </CardContent>
