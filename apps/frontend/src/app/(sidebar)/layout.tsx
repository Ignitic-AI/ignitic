      ...
      <body className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
        <SessionProviderWrapper>
          <SidebarProvider>
            ...
            <SidebarInset>
              {/* Header */}
              <header className="flex h-16 shrink-0 items-center gap-4 border-b border-slate-200/50 justify-between bg-white/90 backdrop-blur-md px-6 shadow-sm">
                <div className="flex items-center gap-4">
                  <SidebarTrigger className="bg-gradient-to-r from-slate-700 to-slate-800 hover:from-slate-800 hover:to-slate-900 text-white p-2 rounded-lg transition-all duration-200 shadow-md" />
                  <Breadcrumb>
                    <BreadcrumbList>
